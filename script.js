...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxoizaoz2yl19S31-XSRR5WdWctG66n3ZUuh3qToYn9cfyrHY500-ge73hkPWqvu5pk/exec';
...
const EMAIL_CONFIG = {
    serviceId: 'service_o1ylzcn',
    templateId: 'template_p5yce9m',
    apiKey: 'xXeXQ_qfv5tNsCQtu'
};
...
class PromoCodeManager {
    ...
    async loadEvents() {
        try {
            ...
            if (!scriptUrl || scriptUrl === 'https://script.google.com/macros/s/AKfycbxoizaoz2yl19S31-XSRR5WdWctG66n3ZUuh3qToYn9cfyrHY500-ge73hkPWqvu5pk/exec') {
